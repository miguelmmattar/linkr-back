...
const schemas_configuration = Object.freeze([
  {
    ...
    schema_name: "nome da propriedade que acessa o schema que vc criou em schemas.js",
    request_data: "por onde virao os dados body | params | headers | query",
    uniques: [
      {
        property: "propriedade que vc quer que exista(ou nao). A propriedade da tabela e do corpo da requisicao devem ter o mesmo nome",
